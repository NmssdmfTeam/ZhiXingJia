...
public class OkHttpClientProvider {
     ...
     * 请求头中的User-Agent定义
     */
    public static String UA = "AndroidPlatform/" + BuildConfig.VERSION_NAME + "(Android" + Build.VERSION.RELEASE + ";"
    ...
    private OkHttpClient createClient(int version, String token) {
        ...
        JLog.i(TAG, "clients size : " + clients.size());
        return client;
    }
...
//            JLog.d(TAG, "protocol =  : " + response.protocol());
            ...
            if (response.body() != null && response.body().contentType() != null) {
                ...
                JLog.d(TAG, "mediaType =  :  " + mediaType.toString());
