...
public class ChangePwdVM extends BaseVM {
    ...
    private ChangePwdCB cb;
    /**
     * 不需要callback可以传null
     *
     * @param callBack
     */
    public ChangePwdVM(ChangePwdCB callBack) {
        super(callBack);
        cb = callBack;
        initData();
    }
    ...
    private void initData() {
        ...
        if (bundle != null) {
            phoneNumber.set(bundle.getString(IntentConfig.PHONE_NUM));
        }
    }
